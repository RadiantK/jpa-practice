...
import com.jpabook.jpashop.domain.item.OrderStatus;
...
public class OrderApiController {
    ...
    public List<OrderQueryDto> ordersV6_distinct() {
    ...
    static class OrderDto {
        ...
        private List<OrderItemDto> orderItems; // Dto안에 엔티티가 존재하면 안됨, wrapping도 안됨
